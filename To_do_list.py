...
def delete_all_tasks():  
    ...
    message_box = messagebox.askyesno('Delete All', 'Are you sure Manoj?')  
...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Manager - MANOJ KUMAR")  
    # setting the geometry of the window  
    guiWindow.geometry("600x450+750+270")  
